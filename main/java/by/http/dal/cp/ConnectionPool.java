...
public class ConnectionPool{
    ...
    static {
        try {
            ...
            LOGGER.error("Error initialize connection pool!: ", e);
        }
    }
    ...
    public void closeConnection(Connection con, PreparedStatement st, ResultSet rs){
        try {
        	...
        	LOGGER.error("Error return connection in pool", e);
        }
        try {
            rs.close();
        } catch (SQLException e){
        	LOGGER.error("Error result set close", e);
        }
        try {
            st.close();
        } catch (SQLException e){
        	LOGGER.error("Error statement close", e);
        }
    }
    public void closePSRS(PreparedStatement st, ResultSet rs){
        try {
            rs.close();
        } catch (SQLException e){
        	LOGGER.error("Error result set close", e);
    ...
    public void closeConnection(Connection con, PreparedStatement st){
        ...
        try {
        	...
        	LOGGER.error("Error error statement close", e);
        }
    }
